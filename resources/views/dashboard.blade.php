    ...
    <section id="service">
        <div class="col-span-4 text-center rounded-xl bg-white shadow-xl shadow-gray-400">
            ...
            <p class="font-medium mx-10 mb-10">Membuat konsep, pengambilan video dan mengedit video</p>
              ...
              <body class="bg-gray-100">
                <div class="container mx-auto px-4 py-8">
                  <h1 class="text-2xl font-semibold text-gray-800 mb-4">Layanan Kami</h1>
                  <div class="relative">
                    <!-- Slide 1 -->
                    <div class="slide active">
                      <div class="bg-white shadow-lg rounded-lg p-4">
                        <h2 class="text-lg font-semibold text-gray-800">Layanan 1</h2>
                        <p class="text-gray-600 mt-2">Deskripsi singkat tentang Layanan 1.</p>
                      </div>
                    </div>
                    ...
                    <div class="slide">
                      <div class="bg-white shadow-lg rounded-lg p-4">
                        <h2 class="text-lg font-semibold text-gray-800">Layanan 2</h2>
                        <p class="text-gray-600 mt-2">Deskripsi singkat tentang Layanan 2.</p>
                      </div>
                    </div>
                    ...
                    <div class="slide">
                      <div class="bg-white shadow-lg rounded-lg p-4">
                        <h2 class="text-lg font-semibold text-gray-800">Layanan 3</h2>
                        <p class="text-gray-600 mt-2">Deskripsi singkat tentang Layanan 3.</p>
                      </div>
                    </div>
                  </div>

                  <div class="flex justify-center mt-4">
                    <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md mr-2" id="prevBtn">Sebelumnya</button>
                    <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md" id="nextBtn">Selanjutnya</button>
                  </div>
                </div>
