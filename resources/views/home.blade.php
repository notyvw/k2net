...
@section('content')
    ...
    {{-- Pricing --}}
    <section id="pricing">
        <div class="grid grid-cols-12 gap-6 mx-4 sm:mx-40 my-4 sm:my-24">
    ...
    {{-- Product --}}
    <section id="product">
            <div class="col-span-12 text-center mt-12 sm:mt-0">
                <p class="font-semibold text-2xl">Our Product</p>
                <p class="font-medium">Penawaran terbaik untuk anda</p>
            </div>
          <div class="grid grid-cols-12 space-around-lg p-6">
            <div class="col-span-12 slide-container overflow-hidden relative sm:mx-auto px-4 py-8">
                    <div class="slide-wrapper flex transition-transform duration-500 ease-in-out space-x-4">
                        <!-- Kartu Produk 1 -->
                        @foreach ($products as $product)
                        <div class="slide w-full sm:w-fit flex-none p-4 bg-white shadow-xl rounded-lg animate">
 ...
 <section id="service">
    <div class="grid grid-cols-12 gap-6 mx-4 sm:mx-40 my-4 sm:my-24">
        <div class="col-span-12 text-center">
            ...
            <p class="font-medium">Pelayanan terbaik untuk anda</p>
        </div>
    <div class="col-span-12 sm:col-span-4 text-center rounded-xl bg-white shadow-xl shadow-gray-400">
    ...
    <div class="hidden sm:block col-span-2 h-20 ">
 ...
 {{-- Contacts --}}
 <section id="contact">
  <div class="grid grid-cols-12 gap-4 sm:mx-40 mx-4">
      <div class="grid grid-cols-1 sm:relative col-span-12 bg-gradient-to-b from-sky-500 from-0% to-cyan-200 to-90% p-4 rounded-lg">
          <p class="text-center mb-4 text-2xl font-semibold tracking-wide text-white">Contact Us</p>
          <div class="flex justify-end w-full">
            <div class="sm:pl-28 bg-white sm:w-10/12">
                <p class="sm:pl-20 text-center sm:text-left pt-10 text-xl font-semibold tracking-wide">Send a Message</p>
                <form action="{{ route('message.store') }}" method="POST" enctype="multipart/form-data">
                  <div class="grid grid-cols-2 gap-10 px-4 sm:px-20 py-10">
                      @csrf
                      <div class="col-span-2 sm:col-span-1 border-b border-gray-900 py-2">
                      ...
                      <button type="submit" class="col-span-2 sm:cols-apn-1 p-4 bg-blue-500 text-white font-semibold rounded-md">Send Message</button>
                  </div>
              </form>
            </div>
        </div>
          <div class="sm:absolute mt-4 sm:mt-0 bg-sky-800 text-white p-4 sm:w-3/12 space-y-5 left-6 top-1/4 rounded-md">
